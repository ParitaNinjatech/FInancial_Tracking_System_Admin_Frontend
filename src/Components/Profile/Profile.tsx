...
import { Avatar, Box, Card, CardContent, Grid, Typography, IconButton, TextField, Button, Link } from '../../common/Index';
import './Profile.css';
...
const Profile = () => {
    ...
    const phoneRegex = /^\+?[1-9]\d{1,14}$/; // Basic international phone number pattern
