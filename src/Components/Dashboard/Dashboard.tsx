                ...
                >
                    ...
                    >
                        <Box sx={{ textAlign: 'center' }}>
                            <Typography variant="h4" color="error">5645</Typography>
                            <Typography variant="subtitle1">Chrome</Typography>
                        </Box>
                        <Box sx={{ textAlign: 'center' }}>
                            <Typography variant="h4" color="warning">4250</Typography>
                            <Typography variant="subtitle1">Mozilla</Typography>
                        </Box>
                        <Box sx={{ textAlign: 'center' }}>
                            <Typography variant="h4" color="primary">3450</Typography>
                            <Typography variant="subtitle1">Safari</Typography>
                        </Box>
                        <Box sx={{ textAlign: 'center' }}>
                            <Typography variant="h4" color="secondary">2500</Typography>
